...
CONSTRAINT IC2 CHECK (NOT(rank IN ('DB guru') AND (salary < 200))),
--IC3: The salary of a 'DB expert' is between 80 and 220.
CONSTRAINT IC3 CHECK (NOT(rank IN('DB expert') AND (salary < 80 OR salary > 220))),
--IC4: The salary of a 'DB rookie' is less than 100.
CONSTRAINT IC4 CHECK (NOT(rank IN('DB rookie') AND (salary > 100)))
);
-------------------------------------------------------------------------
